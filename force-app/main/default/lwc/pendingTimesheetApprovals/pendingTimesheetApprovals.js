...
import getProcessInstanceWorkItem from '@salesforce/apex/TimsheetController.getProcessInstanceWorkItem';
import { NavigationMixin } from 'lightning/navigation';
import Id from "@salesforce/user/Id";
export default class PendingTimesheetApprovals extends LightningElement {
    processInstanceData;
    baseURL;
    customURL;
    currentUserId = Id;
    ...
    wiredRecord({ data, error }) {
        if(data && data.length>0){
            ...
            this.uiMessage = 'Reach out to Admin for Access';
